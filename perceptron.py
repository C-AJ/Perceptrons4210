...
for i in n: #iterates over n
    ...
    for j in r: #iterates over r
        ...
        for k in range(2): #iterates over the algorithms
            ...
            #--> add your Python code here
            runAccuracy = numberRight / total
            if k == 0:
                if runAccuracy > Paccuracy:
                    Paccuracy = runAccuracy
                    print("Highest Perceptron accuracy so far: " + str(Paccuracy) + " learning rate=" + str(i) +
                          " shuffle=" + str(j))
            else:
